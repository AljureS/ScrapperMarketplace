"""
Scraper específico para Copa Airlines
"""
...
class CopaScraper(BaseScraper):
    ...
    def __init__(self):
        super().__init__(
            ...
            airline_code="CM",
            base_url="https://www.copaair.com",
            policies_url="https://www.copaair.com/es/web/co/cambios-reembolsos",
            requires_javascript=False
        )

    def extract_data(self) -> AirlinePolicy:
        """Extrae datos de políticas de Copa Airlines"""
        ...
        transfer_keywords = ['cambio de nombre', 'transferencia', 'modificar pasajero']
        cancellation_keywords = ['cancelación', 'reembolso', 'devolver boleto']
        ...
        if transfer_sections:
            ...
            policy.cost_name_change_intl_cop = extract_cop_amount(transfer_text)
        ...
        policy.notable_exceptions = "Hub en Panamá, política puede variar por origen/destino"
