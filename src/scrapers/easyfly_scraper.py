"""
Scraper específico para EasyFly
"""
...
class EasyFlyScraper(BaseScraper):
    """Scraper específico para EasyFly"""

    def __init__(self):
        super().__init__(
            airline_name="EasyFly",
            airline_code="VE",
            base_url="https://www.easyfly.com.co",
            policies_url="https://www.easyfly.com.co/condiciones-generales",
            requires_javascript=False
        )

    def extract_data(self) -> AirlinePolicy:
        """Extrae datos de políticas de EasyFly"""
        ...
        transfer_keywords = ['cambio de nombre', 'modificación', 'cambiar pasajero']
        cancellation_keywords = ['cancelación', 'reembolso', 'anulación']
        ...
        policy.notable_exceptions = "Aerolínea regional con rutas secundarias"
