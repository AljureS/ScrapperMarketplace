"""
Scraper específico para JetSmart
"""
...
class JetSmartScraper(BaseScraper):
    """Scraper específico para JetSmart"""
    ...
    def __init__(self):
        super().__init__(
            ...
            airline_code="JA",
            base_url="https://jetsmart.com",
            policies_url="https://jetsmart.com/co/es/condiciones-de-transporte",
            requires_javascript=False
        )

    def extract_data(self) -> AirlinePolicy:
        """Extrae datos de políticas de JetSmart"""
        ...
        transfer_keywords = ['cambio de nombre', 'cambiar pasajero', 'modificación']
        cancellation_keywords = ['cancelar', 'reembolso', 'anular']
        ...
        policy.notable_exceptions = "Low-cost chilena, políticas restrictivas típicas de bajo costo"
